                    ...
                    <div class="card-body">
                        <form action="{{ route('barang.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('keterangan_barang') is-invalid @enderror" name="keterangan_barang" rows="5" placeholder="Masukkan Keterangan Barang">{{ old('keterangan_barang') }}</textarea>
